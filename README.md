...
- (Look at "User_Manual" for directions related to playing the hangman game itself)
- (Look at "UML_Project_Lacovic" and "Implementation_Manual" to understand details of program)
