...
to allow for a maximum of 6 possible incorrect guesses (head, body, two arms, two legs).
  - The player will have the ability to enter their own word, and I will specify that it should be 6 letters or less. If possible, I may include the option to provide a randomly generated word for a single player version of the game, though I only might do that if I have enough time later on.
